                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isLightMode
                                ...
                                : creamColor.withOpacity(0.08),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Icon(Icons.group,
                              color: isLightMode ? greenColor : creamColor, size: 22),
                        ),
          ...
          child: SafeArea(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _NavItem(
                    iconPath: "assets/background_elements/Home.svg",
                    label: appLocalizations.home,
                    isSelected: selectedIndex == 0,
                    onTap: () => onItemTapped(0),
                  ),
                  _NavItem(
                    iconPath: "assets/background_elements/Dhikar.svg",
                    label: appLocalizations.dhikr,
                    isSelected: selectedIndex == 1,
                    onTap: () => onItemTapped(1),
                  ),
                  _NavItem(
                    iconPath: "assets/background_elements/Khitma.svg",
                    label: appLocalizations.khitma,
                    isSelected: selectedIndex == 2,
                    onTap: () => onItemTapped(2),
                  ),
                  _NavItem(
                    iconPath: "assets/background_elements/Group.svg",
                    label: appLocalizations.groups,
                    isSelected: selectedIndex == 3,
                    onTap: () => _showGroupsDialog(context, themeProvider),
                  ),
                  _NavItem(
                    iconPath: "assets/background_elements/Profile.svg",
