...
import 'widgets/personalized_reminder_dialog.dart';
          ...
          if (!isSelf)
            _IconBadgeButton(
              ...
              onTap: () async {
                ...
                // Show the new personalized reminder dialog
                await PersonalizedReminderDialog.show(
                  context: context,
                  memberName: member.name,
                  memberId: member.userId,
                  groupId: state.widget.groupId,
                  groupName: state._resolvedGroupName ?? state.widget.groupName ?? 'Group',
                  isDhikr: state.widget.isDhikr,
                );
              },
            ),
        ],
